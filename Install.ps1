...
$Application_Name = "CHECKPOINT CAPSULE VPN"          # Nom de l'application
$Application_Version = "1.0.14.0"       # Version de l'application Vxx.xx.xx
$Editor = "Checkpoint"                    # Editeur
$Install_Path = "C:\Program Files\WindowsApps\B4D42709.CheckPointVPN_1.0.14.0_x64__wz4qkf3wxpc74"              # Install folder of the application
$Technologie = "APPX"               # MSI, EXE or APPX
$Arch = 64                        # 32 or 64
